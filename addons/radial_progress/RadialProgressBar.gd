...
func _draw():
	draw_circle_arc(Vector2(0,0),bg_radius,0,360,bg_color);
	angle = progress*360/max_value;
	draw_circle_arc(Vector2(0,0),radius,angle0,angle0+angle,bar_color);
